...
async function assembleVerifiedStoredPreview(orderId: string) {
  ...
  console.info('[DirectPreview] six MP4s verified; calling assembleMovie now', { orderId });
  try {
    ...
    console.error('[DirectPreview] ASSEMBLY FAILED AFTER SIX VERIFIED MP4S', { orderId, error });
    throw error;
  }
}
