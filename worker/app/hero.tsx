...
const LOGO = 'https://raw.githubusercontent.com/debeaux13-cloud/scaling-palm-tree/main/Untitled%20design.png';

export function Hero() {
  return (
    <>
      <header className="mcs-header">
        <a href="#top" className="mcs-brand"><span className="logo-crop"><img src={LOGO} alt="Main Character Studios by Tiffani" /></span><div><strong>Main Character Studios</strong><span>by Tiffani</span><small>WHERE YOUR STORY BECOMES A MOVIE</small></div></a>
      ...
      <section className="hero-section">
        ...
        <div className="hero-art" aria-label="Main Character Studios"><span className="hero-logo-crop"><img src={LOGO} alt="Main Character Studios by Tiffani" /></span></div>
      </section>
    </>
  );
}
